...
public class SimulaWithCharts {
	...
	public SimulaWithCharts(double mean_interarrival, double mean_service, double time_end) {

		ed = new ExponentialDistribution(SEED);
	...
	public static void main(String[] args) {
		...
		double end_time = Double.parseDouble(args[2]);

		SimulaWithCharts mm1 = new SimulaWithCharts(mean_interarrival, mean_service, end_time);
